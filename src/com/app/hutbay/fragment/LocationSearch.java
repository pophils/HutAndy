...
import Task.FilterSearchAjaxTask;
...
public class LocationSearch extends Fragment{
	...
	private FilterSearchAjaxTask ajaxTask;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ajaxTask = new FilterSearchAjaxTask(loadingGifDialog, host, this);
	...
	public void processResult(String jsonresult){		
		ajaxTask.cancel(true);		
		Intent loadSearchResultActivity = new Intent(host, LocationSearchResult.class);
		...
		loadSearchResultActivity.putExtra(Konstant.TAG_SEARCH_URL_XTRA, searchUrl);
